...
class BankingResponseNormalizer extends SerializerAwareNormalizer implements DenormalizerInterface, NormalizerInterface
{
    public function supportsDenormalization($data, $type, $format = null)
    {
        if ($type !== 'Flinks\\BankingServices\\Model\\BankingResponse') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \Flinks\BankingServices\Model\BankingResponse) {
            return true;
        }
        return false;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Flinks\BankingServices\Model\BankingResponse();
